 ...
 *
 */
public class GateMarket extends Market{
	...
	public static String API_DOMAIN = "http://data.gate.io/api2/1";
	...
	public Map<String, Object> ticker(String currency) {
		...
		String callback = "{}";
		try {
			String url = API_DOMAIN + "/ticker/" + currency;
	...
	public Map<String, Object> retriveMarketDepth(String currency, int depth) throws IOException{
		...
		String url = API_DOMAIN + "/orderBook/" + currency;
