 ...
 *
 */
public class BcexMarket extends Market{
	...
	public static String API_DOMAIN = "http://www.bcex.ca/Api_Order/";
	...
	public Map<String, Object> ticker(String currency) {
		...
		String callback = "{}";
		try {
			String url = API_DOMAIN + "ticker?symbol=" + currency.toLowerCase();
	...
	public Map<String, Object> retriveMarketDepth(String currency, int depth) throws IOException{
		...
		String url = API_DOMAIN + "depth?symbol=" + currency.toLowerCase();
	...
	public JSONArray getAsks(String currency, int size) throws IOException{
		Map obj = (Map)this.retriveMarketDepth(currency, size).get("data");
		JSONArray askArray = (JSONArray)obj.get("asks") ;
	...
	public JSONArray getBids(String currency, int size) throws IOException{
		Map obj = (Map)this.retriveMarketDepth(currency, size).get("data");
		JSONArray bidArray = (JSONArray) obj.get("bids");
