...
public class HttpUtilManager {
	...
	public static SSLContext createIgnoreVerifySSL() throws NoSuchAlgorithmException, KeyManagementException {
		...
		// 实现丄1�7个X509TrustManager接口，用于绕过验证，不用修改里面的方泄1�7
	...
	public static String sendHttps(String url, Map<String, String> map, String encoding) {
		...
		try {
			...
			// 设置协议http和https对应的处理socket链接工厂的对豄1�7
			...
			System.out.println("请求地址＄1�7" + url);
			System.out.println("请求参数＄1�7" + nvps.toString());

			// 设置header信息
			// 指定报文头�1�7�Content-type】�1�7��1�7�User-Agent〄1�7
